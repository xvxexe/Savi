...
function getDefaultDates() {
  return { checkIn: "2026-04-24", checkOut: "2026-04-27" };
}
      ...
      <div className={`rounded-[28px] border border-slate-200 bg-white/92 ${compact ? "p-5" : "p-5 md:p-7"} shadow-[0_24px_70px_rgba(15,23,42,0.10)] backdrop-blur-xl`}>
        <div className="flex items-start justify-between gap-4">
          <div>
            ...
            <p className="mt-2 text-sm leading-relaxed text-slate-600">Calendario, ospiti, extra e riepilogo soggiorno in una demo più rifinita e immersiva.</p>
          </div>
          <div className="rounded-[22px] border border-sky-100 bg-sky-50/80 px-4 py-3 text-right">
        ...
        {step === 1 ? (
          <div className="mt-6 space-y-4">
            <div className="grid gap-3 sm:grid-cols-2">
              <DateDisplayButton label="Check-in" value={checkIn} onClick={() => setPicker("checkIn")} />
  ...
  return (
    <AnimatedSection className="mx-auto max-w-7xl px-4 pb-14 sm:px-6 md:pb-16 lg:px-8">
      <div className="rounded-[30px] border border-slate-200 bg-[linear-gradient(135deg,#fbfdff_0%,#f1f7ff_60%,#f8fbff_100%)] p-6 shadow-[0_30px_100px_rgba(15,23,42,0.10)] md:p-10">
        <div className="grid items-center gap-6 md:gap-8 lg:grid-cols-[0.86fr_1.14fr]">
          <div>
        ...
        <div className="space-y-6">
          ...
          <div className="rounded-[28px] border border-slate-200 bg-white/92 p-6 shadow-[0_20px_60px_rgba(15,23,42,0.07)] backdrop-blur-xl">
            ...
            <div className="mt-5 grid gap-4 md:grid-cols-2">
              {[
                ["1", "Seleziona le date", "Si vede il calendario e si scelgono check-in e check-out in modo più ordinato e visivo."],
